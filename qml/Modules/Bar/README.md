...
- The bar only appears on the main monitor, chosen by the shell-wide [`mainMonitor`](../../Settings/README.md#shell) setting. If no main monitor is set or connected, the bar appears on every monitor
